  ...
  async verifySession(
    ...
    try {
      ...
      if (typeof openId !== "string" || !openId) {
        console.log(`[Auth] JWT valid but openId missing/invalid in payload: ${JSON.stringify(Object.keys(payload))}`);
        return null;
      }
      return {
        openId,
      ...
      if (errCode === "ERR_JWS_SIGNATURE_VERIFICATION_FAILED") {
        ...
        console.log(`[Auth] JWT verification failed: ${errCode}`);
      }
      return null;
    }
  }
