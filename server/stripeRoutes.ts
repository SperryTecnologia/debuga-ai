  ...
  app.post("/api/stripe/create-checkout", async (req: Request, res: Response) => {
    ...
    try {
      ...
      try {
        ...
        console.error(`[Stripe Checkout] Stripe not configured:`, configErr.message);
        res.status(503).json({
          error: "Checkout não configurado neste ambiente. Configure Stripe no painel admin (Settings → Payment).",
