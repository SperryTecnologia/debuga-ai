...
const PLANS: PlanDisplay[] = [
  ...
  },
  {
    id: "enterprise",
    name: "Enterprise",
    description: "Canal consultivo com equipe técnica sênior, integrações e roadmap cloud/on-premise",
    icon: Building2,
    priceMonthly: 499.90,
    priceYearly: 4799.00,
    features: [
      "Tudo do Pro incluído",
      "Canal consultivo com equipe técnica sênior",
      "Integrações sob projeto (Zabbix, Wazuh, etc.)",
      "SSO / SAML / LDAP (sob projeto)",
      "Gerente de conta dedicado",
      "Treinamento da equipe",
      "SLA personalizado conforme contrato",
      "Roadmap cloud/on-premise para cenários Enterprise",
      "Escopo, integrações e atendimento conforme contrato",
    ],
