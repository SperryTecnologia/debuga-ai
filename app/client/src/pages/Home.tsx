            ...
            >
              {[
                ...
                },
                {
                  ...
                  desc: "Autenticação própria, banco dedicado, storage compatível com S3, provedores LLM e possibilidade de inferência local experimental em ambientes on-premise.",
                },
                {
                  icon: Building2,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-2">
                ...
                <a
                  href="https://github.com/SperryTecnologia/debuga-ai/blob/main/docs/ARCHITECTURE_PT-BR.md"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-muted-foreground hover:text-primary transition-colors inline-flex items-center gap-2"
                >
